...
public final class Functions {
    ...
    /**
     *
     * Throws an Exception if a Boolean assertion is True
     *
     * @param value Boolean assertion
     * @param supplier Supplier Function that throws an Exception if value is True
     *
     */
    public static <X extends Throwable> void acceptTrueThrows(Boolean value, Supplier<? extends X> supplier) throws X {
        if (Boolean.TRUE.equals(value))
            throw supplier.get();
    }
    ...
    /**
     *
     * Throws an Exception if a Boolean assertion is False
     *
     * @param value Boolean assertion
     * @param supplier Supplier Function that throws an Exception if value is False
     *
     */
    public static <X extends Throwable> void acceptFalseThrows(Boolean value, Supplier<? extends X> supplier) throws X {
        if (Boolean.FALSE.equals(value))
            throw supplier.get();
    }
